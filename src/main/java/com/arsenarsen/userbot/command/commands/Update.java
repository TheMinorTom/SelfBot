...
public class Update implements Command {
    ...
    public void dispatch(String[] args, MessageChannel channel, Message msg) {
        try {
            ...
            Files.copy(new URL("https://ci.arsenarsen.com/job/SelfBot/lastSuccessfulBuild/artifact/target/UserBot-jar-with-dependencies.jar").openStream(),
                    current.toPath(), StandardCopyOption.REPLACE_EXISTING);
